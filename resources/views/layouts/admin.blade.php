...
<nav class="admin-sidebar bg-surface shadow-sm h-screen fixed left-0 top-0 flex flex-col py-6 px-4 z-20">
    ...
    <div class="flex flex-col gap-2 flex-grow">
        ...
        <a title="Pendaftar Lomba" class="admin-nav-link {{ request()->routeIs('admin.registrations.*') ? 'text-primary font-bold border-r-4 border-primary bg-secondary-container/20' : 'text-on-surface-variant' }} flex items-center gap-3 p-3 rounded-l-lg" href="{{ route('admin.registrations.index') }}"><span class="material-symbols-outlined">app_registration</span><span class="sidebar-label">Pendaftar Lomba</span></a>
        <a title="Map & Locations" class="admin-nav-link {{ request()->routeIs('admin.locations.*') ? 'text-primary font-bold border-r-4 border-primary bg-secondary-container/20' : 'text-on-surface-variant' }} flex items-center gap-3 p-3 rounded-l-lg" href="{{ route('admin.locations.index') }}"><span class="material-symbols-outlined">map</span><span class="sidebar-label">Map & Locations</span></a>
